...
/// <summary>
/// Класс WeaponDefenition позволяет настраивать свойства конкретного вида оружия
/// в инспекторе. Для этого класс Main будет хранить массив элементов типа WeaponDefenition.
/// </summary>
[System.Serializable]
